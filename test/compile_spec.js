...
describe('$compile', function() {
  ...
  it('compiles classs directives', function() {
    var injector = makeInjectorWithDirectives('myDirective', function() {
      return {
        restrict: 'EACM',
        compile: function(element) {
  ...
  describe('attributes', function() {
    ...
    it('passes the elemnt attributes to the compile function', function() {
      registerAndCompile(
        'myDirective',
  ...
  describe('linking', function() {
    ...
    it('allows binding an invokable expression on he parent scope', function() {
      var givenScope;
      var injector = makeInjectorWithDirectives('myDirective', function() {
        return {
          scope: {
  ...
  describe('controllers', function() {
    ...
    it('can be requried from a parent directive', function() {
      function MyController() {}
      var gotMyController;
      var injector = createInjector(['ng', function($compileProvider) {
        $compileProvider.directive('myDirective', function() {
    ...
    it('can be required from parent in object from', function() {
      function MyController() {}
      var gotControllers;
      var injector = createInjector(['ng', function($compileProvider) {
        $compileProvider.directive('myDirective', function() {
  ...
  describe('templateUrl', function() {
    ...
    describe('with transclusion', function() {
      ...
      it('works when a template arrives first', function() {
        var injector = makeInjectorWithDirectives({
      ...
      it('works whena  template arrives after', function() {
        var injector = makeInjectorWithDirectives({
          myTranscluder: function() {
            return {
              transclude: true,
  ...
  describe('transclude', function() {
      ...
      var injector = makeInjectorWithDirectives({
        myTranscluder: function() {
          return {
            ...
            scope: true,
            link: function(scope, element, attrs, ctrl, transclude) {
              scope.anAttr = 'Shadows attribute';
              element.append(transclude());
            }
          };
        },
    ...
    it('allows passing anothere scope to transclusion function', function() {
  ...
  describe('components', function() {
    ...
    it('are element directives with controllers', function() {
      ...
      injector.invoke(function($compile, $rootScope) {
        ...
        expect(el[0]).toBe(componenElement[0]);
      });
    });
  ...
  describe('lifecycle', function() {
    ...
    it('runs $onChanges fro all components in the same digest', function() {
      var injector = createInjector(['ng', function($compileProvider) {
        $compileProvider.component('first', {
          bindings: {myBinding: '<'},
          controller: function() {
