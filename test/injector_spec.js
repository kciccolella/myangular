...
describe('injector', function() {
  ...
  describe('annotate', function() {
    ...
    it('returns annotations parsed fromm function args when not annotated', function() {
      var injector = createInjector([]);
    ...
    it('strips several comments from the argument lists when parsing', function() {
      var injector = createInjector([]);
    ...
    it('instantiates a provider if given a constructor function', function() {
      var module = window.angular.module('myModule', []);
